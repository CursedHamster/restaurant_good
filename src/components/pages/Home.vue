...
<template>
  <main
    role="main"
    class="w-full h-screen relative grid place-content-center text-center bg-gradient-to-b from-[#111827b7] to-zinc-950"
  >
    <video
      ...
      muted
    />
    <div class="custom-global-px flex flex-col gap-4 max-w-5xl">
