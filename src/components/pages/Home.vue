...
<template>
  ...
  >
    <!-- <video
      ...
      muted
    /> -->
    <div class="absolute top-0 left-0 right-0 bottom-0 z-[-1] w-full h-full after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-to-b after:from-[#16161cdc] after:to-zinc-950">
      <video
